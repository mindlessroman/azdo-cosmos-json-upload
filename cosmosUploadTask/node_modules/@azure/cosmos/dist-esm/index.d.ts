...
export { Operation, OperationResponse, CreateOperation, UpsertOperation, ReplaceOperation, DeleteOperation, ReadOperation, OperationBase, OperationWithItem, OperationInput } from "./utils/batch";
export { ConnectionMode, ConsistencyLevel, ConnectionPolicy, DatabaseAccount, DataType, Index, IndexedPath, IndexingMode, IndexingPolicy, SpatialIndex, SpatialType, GeospatialType, IndexKind, Location, PartitionKey, PartitionKeyDefinition, PermissionMode, TriggerOperation, TriggerType, UserDefinedFunctionType } from "./documents";
...
export * from "./request";
export { CosmosHeaders, SqlParameter, SqlQuerySpec, JSONValue, JSONArray, JSONObject } from "./queryExecutionContext";
